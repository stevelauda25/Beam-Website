...
export const initialFiles: DemoFile[] = [
  ...
  { id: 'typography-scales', folderId: 'product-resources', name: 'typography-scales.pdf', size: 42_000_000, modified: now - day * 2, mimeType: 'application/pdf', previewUrl: '/assets/hero/demo/brand-guidelines.pdf' },
